        ...
        reply_markup = InlineKeyboardMarkup([
                [
                    InlineKeyboardButton
                        (
                            text = "✅️ repo yoxdu ✅️", url = "https://github.com/naxxx"
                         )
                ],
                [
                    InlineKeyboardButton
...
DATABASE = os.environ.get("DATABASE") # MongoDB veritabanınızın url'si. Nasıl alacağınızı bilmiyorsanız destek grubu @RepoHaneX'e gelin.
...
GROUP_SUPPORT = os.environ.get("GROUP_SUPPORT", "teamabasofsupport1") # Botunuzdan yasaklanan kullanıcıların itiraz işlemleri için başvuracağı grup, kanal veya kullanıcı. Boş bırakırsanız otomatik olarak OWNER_ID kimliğine yönlendirecektir.
...
DEV_ID = int(os.environ.get("DEV_ID")) # Sahip hesabın id'si
